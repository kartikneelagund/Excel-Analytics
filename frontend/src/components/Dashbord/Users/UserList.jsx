...
const getUsers = async () => {
  try {
    ...
    const activeUsers = res.data.filter(user => user.status !== "deleted");
    setRows(activeUsers.map(u => ({
      id: u._id,
